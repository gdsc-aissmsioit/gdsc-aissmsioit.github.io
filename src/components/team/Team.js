  ...
  <>
    ...
    <div>
		<div className="button-container">
		  ...
		  <button 
			className={`custom-button gred ${selectedYear === '2023' ? 'active' : ''}`}
		  ...
		  <button
			className={`custom-button gyellow ${selectedYear === '2022' ? 'active' : ''}`}
		  ...
		  <button
			className={`custom-button ggreen ${selectedYear === '2021' ? 'active' : ''}`}
